...
const listingCoords = (answers) => {
  ...
  page2coords.push(coords.boolCoords(answers.L72, 245, 321))
  ...
  page4coords.push(coords.boolCoords(answers.L146, 254, 642))
  ...
  page4coords.push(coords.boolCoords(answers.L175, 260, 178))
