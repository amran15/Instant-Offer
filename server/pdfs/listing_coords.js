...
const listingCoords = (answers) => {
  ...
  page2coords.push(boolCoords(answers.L72, 245, 321, 36))
  ...
  page4coords.push(boolCoords(answers.L146, 254, 642, 47))
  ...
  page4coords.push(boolCoords(answers.L175, 260, 178, 28))
  ...
  // page5coords.push(boolCoords(answers.L196, 65, 524))
