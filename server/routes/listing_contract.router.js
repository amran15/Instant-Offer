...
router.post('/save', (req, res) => {
    ...
    VALUES($1, $2, $3, $4);`
    pool.query(querySave, [req.body.user_id, req.body.L3, req.body.L4, req.body.L6, req.body.L7, req.body.L8, req.body.L12, 
        req.body.L13, req.body.L41, req.body.L54, req.body.L63, req.body.L71, req.body.L72, req.body.L73, req.body.L115, 
        req.body.L118, req.body.L119, req.body.L121, req.body.L131,req.body.L146, req.body.L148A, req.body.L148B, 
        req.body.L148C, req.body.L150A, req.body.L150B, req.body.L150C, req.body.L152A, req.body.L152B, req.body.L163,
        req.body.L164, req.body.L165A, req.body.L165B, req.body.L175, req.body.L196, req.body.L198,req.body.L200, req.body.L237,])
        .then(() => {
            res.sendStatus(201);
        }).catch(error => {
            console.log('error making INSERT for post listing_contract', error);
            res.sendStatus(500);
        })
});
